...
const (
	...
	Gemini38Live                      string = "gemini-3.8-live"
	Gemini38LiveExtendedThinking      string = "gemini-3.8-live-extended-thinking"
...
var Models = map[string]llm.Model{
	...
	Gemini38LiveExtendedThinking: {
		...
		Provider:            "gemini",
		APIModel:            "gemini-3.8-live-extended-thinking",
		Currency:            "USD",
		ContextWindow:       131072,
		DefaultMaxTokens:    65536,
		CanReason:           true,
