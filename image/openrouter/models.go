...
const (
	...
	GPTImage25Flare           string = "openrouter.gpt-image-2.5-flare"
	GPTImage25Sunburst        string = "openrouter.gpt-image-2.5-sunburst"
...
var Models = map[string]image.GenerationModel{
	...
	GPTImage25Flare: {
		ID:       GPTImage25Flare,
		Name:     "OpenRouter – GPT Image 2.5 Flare",
		Provider: "openrouter",
		APIModel: "openai/gpt-image-2.5-flare",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.00003},
		},
		MaxPromptTokens: 400000,
	},
	GPTImage25Sunburst: {
		ID:       GPTImage25Sunburst,
		Name:     "OpenRouter – GPT Image 2.5 Sunburst",
		Provider: "openrouter",
		APIModel: "openai/gpt-image-2.5-sunburst",
		Currency: "USD",
		Pricing: map[string]map[string]float64{
			"default": {"default": 0.00003},
		},
